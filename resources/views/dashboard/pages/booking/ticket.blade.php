...
<body style="font-family: Arial;">
    <table>
        <tr>
            ...
            <td style="width: 30%;">
                <img src="{{ public_path('dist/img/logo-kemenkes.png') }}" style="width: 50%;">
            </td>
        </tr>
    </table>
    <table class="table mt-1">
        <tr>
            ...
            <td style="width: 50%;">
                ...
                <span style="font-size: 12px; font-weight: bold;">Keberangkatan Tanggal Rabu, 26 Maret 2025 Pukul 08.00 WIB</span> <br>
    ...
    <table style="width: 100%;">
        ...
        <tbody>
            ...
            <tr style="border: 1px solid #000;">
                ...
                <td style="text-align: center;">{{ $peserta->bus_id }}</td>
                <td style="text-align: center;">{{ $peserta->kode_seat }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
